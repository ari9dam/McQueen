...
python pytorch_transformers/models/hf_scorer.py --input_data_path physical_merged_dev.jsonl   --eval_batch_size 1 --model_dir scratch/kkpal/physical/noq/tiedws_128_9e-6_10865  --bert_model bert-large-uncased-whole-word-masking --mcq_model bert-mcq-weighted-sum  --tie_weights_weighted_sum --output_data_path .
