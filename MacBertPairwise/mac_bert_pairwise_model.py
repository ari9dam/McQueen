...
@Model.register("mac_bert_mcq_pairwise")
class MACBert(Model):
    '''
    ...
    def forward(self, # type: ignore
        ...
        _, pooled_links = self.bert_model(input_ids=links,
        ...
        link_pooled = replace_masked_values(
        ...
        pooled = torch.sum(summary, -2) / coverage_mask.unsqueeze(-1)
