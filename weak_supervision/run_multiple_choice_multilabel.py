...
from pytorch_transformers import (WEIGHTS_NAME, BertConfig,
                                  BertTokenizer, BertPreTrainedModel, BertModel, RobertaModel,
                                  XLNetConfig, XLNetPreTrainedModel, XLNetModel,
                                  XLNetTokenizer, RobertaConfig, RobertaTokenizer, ROBERTA_PRETRAINED_MODEL_ARCHIVE_MAP)

from pytorch_transformers import AdamW, WarmupLinearSchedule

from pytorch_transformers.modeling_utils import SequenceSummary

from utils_multiple_choice_multilabel import (convert_examples_to_features, processors)
