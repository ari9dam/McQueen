...
def create_masked_lm_predictions(tokens, masked_lm_prob, max_predictions_per_seq, whole_word_mask, vocab_list):
    ...
    for (i, token) in enumerate(tokens):
        if token == "[CLS]" or token == "[SEP]":
            continue
        if token in [',','wants','sky',"##ler",'a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v','w','x','y','z',"'",".",'the','is','a','because','wanted','before','needed','seen','as','feels','feel','want','which', 'has', 'an', 'effect', 'on', 'others','casey', 'riley', 'jessie', 'jackie','avery','jaime','peyton', 'kerry', 'jody', 'kendall','peyton', 'skyler', 'frankie', 'pat', 'quinn']:
            continue
...
def main():
    ...
    parser.add_argument("--bert_model", type=str, required=True,
                        choices=["bert-base-uncased", "bert-large-uncased", "bert-base-cased",
                                 "bert-base-multilingual-uncased", "bert-base-chinese","bert-large-uncased-whole-word-masking" ,"bert-base-multilingual-cased","bert-large-cased-whole-word-masking"])
